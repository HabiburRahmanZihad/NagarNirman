        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {task.status === 'rejected' && task.rejectionReason && (
              ...
              >
                ...
                <p className="text-red-700 leading-relaxed">{task.rejectionReason}</p>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="text-center">
                <div className="text-5xl font-bold text-yellow-600 mb-2">{rewardPoints}</div>
                <p className="text-gray-600 font-medium">Points upon verification</p>
                ...
                {task.rating && (
                  <div className="mt-4">
                    <p className="text-sm text-gray-500 mb-2">Authority Rating</p>
                ...
                {task.deadline && (
                  <div className={`p-3 rounded-lg border-2 ${new Date(task.deadline) < new Date()
                    ...
                    {new Date(task.deadline) >= new Date() && new Date(task.deadline) < new Date(Date.now() + 2 * 24 * 60 * 60 * 1000) && (
                      <p className="text-xs text-orange-600 font-semibold mt-1">⏰ Deadline approaching!</p>
                    )}
                  </div>
                )}
              </div>
